...
# Load data
PATH = Path("/Users/jangaliot/Desktop/DATATHON/NOVARTIS-DATATHON/data/processed")
...
train_clusters = train['cluster_nl'].unique()
...
# Save submission
SAVE_PATH = Path("/Users/jangaliot/Desktop/DATATHON")
ATTEMPT = "attempt_x"
